...
public class Mainclass {
    public static void main(String [] args){
        ...
        BottleDispenser bottledispenser = new BottleDispenser(); //luodaan bottledispenser olio
        
        //mahd. valikon avulla erilaisten pullojen ostaminen
