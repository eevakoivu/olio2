...
public class ReadAndWriteIO {
        ...
        //tallennetaan pituus alle 30 merkkiä, mutta eivät tyhjiä
        //length()
        ...
        try {
            ...
            while((output = br.readLine()) != null){
                //jos ei tyhjä ja alle 30 merkkiä
                if (!(output.trim().isEmpty()) && (output.length() < 30)){ 
